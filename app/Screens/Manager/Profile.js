...
const ManagerProfile = ({ navigation }) => {
  ...
  // Determine status styles based on currentStatus
  const isActive = managerData.currentStatus === "Active";
  const statusDotColor = isActive ? "#4CAF50" : "#FF5252";
  const statusTextColor = isActive ? "#4CAF50" : "red";
  const statusBadgeBackgroundColor = isActive ? "#E8F5E9" : "#FFB3B2";
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        <Text style={styles.position}>{managerData.position || "Manager"}</Text>
        <View
          style={[
            styles.statusBadge,
      ...
      <View style={styles.infoSection}>
        ...
        {renderInfoItem("mail", "Email", managerData.email)}
        {renderInfoItem("call", "Phone", managerData.mobile)}
        {renderInfoItem("location", "Address", managerData.address)}
      </View>

      <View style={styles.infoSection}>
        <Text style={styles.sectionTitle}>Work Information</Text>
        {renderInfoItem("business", "Department", managerData.department)}
        {renderInfoItem("briefcase", "Company", managerData.companyName)}
        {renderInfoItem("people", "Team Size", managerData.teamSize || "0")}
        {renderInfoItem("calendar", "Join Date", managerData.joinDate)}
      </View>
            ...
            <ScrollView style={styles.modalScroll}>
              ...
              <View style={styles.inputSection}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditedData({ ...editedData, teamSize: text })
                  }
